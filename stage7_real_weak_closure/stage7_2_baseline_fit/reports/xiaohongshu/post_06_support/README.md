...
- `../post_06/01_cover.png`：0.92% 反直觉数字封面。
- `../post_06/02_who_blocks_calibration.png`：76.26% 与 0.92% 的共同分母比较。
- `../post_06/03_half_the_shadow.png`：自阴影与未计算投射阴影的机制示意。
...
脚本出图前会校验：18 × 488,800 = 8,798,400；6,709,508 / 8,798,400 = 76.26%；81,005 / 8,798,400 = 0.92%；35,525 + 45,480 = 81,005；最低太阳角与最低 lit 比例均对应 order 1、21；以及 Mconf 只覆盖自阴影、五类未覆盖项和“乐观上界”冻结原文。
