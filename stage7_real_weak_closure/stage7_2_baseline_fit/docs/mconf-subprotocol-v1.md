...
- **合同依据：** Stage 7.2 合同 ②
- **建立日期：** 2026-08-07
- **批准：** 所有者于 2026-08-07 批准——「批准，缺口归 7.5/7.6」。批准内容包括
  接受 `cos_i > 0.1` 只覆盖自阴影这一边界，以及由此产生的几何支持乐观上界。
- **冻结后效力：** 本文件即 Stage 7.2 合同 ② 所要求的 Mconf 子协议。任何修改须新立
  v2 并声明 supersession scope，不得覆盖本文件。
